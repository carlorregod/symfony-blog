 ...
 */
final class Version20210826215224 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comentario AS SELECT id, user_id, post_id, comentario, fecha_publicacion FROM comentario');
        ...
        $this->addSql('INSERT INTO comentario (id, user_id, post_id, comentario, fecha_publicacion) SELECT id, user_id, post_id, comentario, fecha_publicacion FROM __temp__comentario');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__profesion AS SELECT id, user_id, nombre FROM profesion');
        ...
        $this->addSql('INSERT INTO profesion (id, user_id, nombre) SELECT id, user_id, nombre FROM __temp__profesion');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comentario AS SELECT id, user_id, post_id, comentario, fecha_publicacion FROM comentario');
        $this->addSql('DROP TABLE comentario');
        $this->addSql('CREATE TABLE comentario (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, post_id INTEGER DEFAULT NULL, comentario VARCHAR(255) NOT NULL, fecha_publicacion DATE NOT NULL)');
        $this->addSql('INSERT INTO comentario (id, user_id, post_id, comentario, fecha_publicacion) SELECT id, user_id, post_id, comentario, fecha_publicacion FROM __temp__comentario');
        $this->addSql('DROP TABLE __temp__comentario');
        $this->addSql('CREATE INDEX IDX_4B91E702A76ED395 ON comentario (user_id)');
        $this->addSql('CREATE INDEX IDX_4B91E7024B89032C ON comentario (post_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__profesion AS SELECT id, user_id, nombre FROM profesion');
        $this->addSql('DROP TABLE profesion');
        $this->addSql('CREATE TABLE profesion (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, nombre VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO profesion (id, user_id, nombre) SELECT id, user_id, nombre FROM __temp__profesion');
        $this->addSql('DROP TABLE __temp__profesion');
        $this->addSql('CREATE INDEX IDX_7CBDAD0AA76ED395 ON profesion (user_id)');
    }
